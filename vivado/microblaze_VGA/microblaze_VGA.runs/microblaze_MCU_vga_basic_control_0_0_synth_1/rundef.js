...
ISEStep( "vivado",
         "-log microblaze_MCU_vga_basic_control_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source microblaze_MCU_vga_basic_control_0_0.tcl" );
