...
\keycodev[15]_i_10\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0001"
    )
        port map (
...
\keycodev[15]_i_11\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0080"
    )
        port map (
...
\keycodev[15]_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"9009"
    )
        port map (
...
\keycodev[15]_i_4\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"7"
    )
        port map (
...
\keycodev[15]_i_5\: unisim.vcomponents.LUT6
    generic map(
...
\keycodev[15]_i_8\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"9009000000009009"
    )
        port map (
...
\keycodev[15]_i_9\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"9009000000009009"
    )
        port map (
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ps2_keyboard_v1_0_S00_AXI is
  ...
  attribute SOFT_HLUTNM of \axi_rdata[14]_i_2\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \axi_rdata[16]_i_2\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \axi_rdata[17]_i_2\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \axi_rdata[26]_i_2\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \axi_rdata[29]_i_2\ : label is "soft_lutpair7";
  ...
  attribute SOFT_HLUTNM of \keycodev[15]_i_7\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \led[0]_INST_0\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \led[1]_INST_0\ : label is "soft_lutpair9";
...
\keycodev[15]_i_3\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00000008"
    )
        port map (
...
\keycodev[15]_i_7\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"EFFF"
    )
        port map (
...
uut: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_PS2Receiver
     port map (
      ...
      PS2Clk => PS2Clk,
      PS2Data => PS2Data,
      Q(15 downto 8) => keycodev_0(15 downto 8),
      Q(7 downto 0) => keycodev(7 downto 0),
      S(1) => uut_n_8,
      S(0) => uut_n_9,
