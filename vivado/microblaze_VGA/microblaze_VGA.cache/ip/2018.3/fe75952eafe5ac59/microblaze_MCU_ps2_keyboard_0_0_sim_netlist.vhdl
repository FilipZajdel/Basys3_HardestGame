...
\old_keycode_reg[0]\: unisim.vcomponents.FDRE
     port map (
      C => flag,
      CE => '1',
      D => keycode(0),
...
\old_keycode_reg[1]\: unisim.vcomponents.FDRE
     port map (
      C => flag,
      CE => '1',
      D => keycode(1),
...
\old_keycode_reg[2]\: unisim.vcomponents.FDRE
     port map (
      C => flag,
      CE => '1',
      D => keycode(2),
...
\old_keycode_reg[3]\: unisim.vcomponents.FDRE
     port map (
      C => flag,
      CE => '1',
      D => keycode(3),
...
\old_keycode_reg[4]\: unisim.vcomponents.FDRE
     port map (
      C => flag,
      CE => '1',
      D => keycode(4),
...
\old_keycode_reg[5]\: unisim.vcomponents.FDRE
     port map (
      C => flag,
      CE => '1',
      D => keycode(5),
...
\old_keycode_reg[6]\: unisim.vcomponents.FDRE
     port map (
      C => flag,
      CE => '1',
      D => keycode(6),
...
\old_keycode_reg[7]\: unisim.vcomponents.FDRE
     port map (
      C => flag,
      CE => '1',
      D => keycode(7),
...
uut: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_PS2Receiver
     port map (
      ...
      PS2Clk => PS2Clk,
      PS2Data => PS2Data,
      Q(7 downto 0) => keycode(7 downto 0)
    );
end STRUCTURE;
library IEEE;
use IEEE.STD_LOGIC_1164.ALL;
