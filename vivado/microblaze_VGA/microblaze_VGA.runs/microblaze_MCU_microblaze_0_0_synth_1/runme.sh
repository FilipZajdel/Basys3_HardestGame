...
HD_PWD='/home/filip/Projects/xilinx/microblaze_VGA/microblaze_VGA.runs/microblaze_MCU_microblaze_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log microblaze_MCU_microblaze_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source microblaze_MCU_microblaze_0_0.tcl
