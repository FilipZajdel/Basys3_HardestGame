...
HD_PWD='/home/filip/Projects/xilinx/ip_repo/edit_ps2_keyboard_v1_0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ps2_keyboard_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ps2_keyboard_v1_0.tcl
