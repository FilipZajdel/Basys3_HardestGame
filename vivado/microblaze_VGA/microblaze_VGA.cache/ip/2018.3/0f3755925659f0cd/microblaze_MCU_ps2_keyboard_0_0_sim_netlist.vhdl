...
\keycodev[15]_i_5\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"EFFFFFFF"
    )
        port map (
      I0 => \^keycode_reg[15]_0\(1),
      I1 => \^keycode_reg[15]_0\(3),
      I2 => \^keycode_reg[15]_0\(5),
      I3 => \^keycode_reg[15]_0\(7),
      I4 => \keycodev[15]_i_9_n_0\,
      O => \keycodev[15]_i_5_n_0\
    );
\keycodev[15]_i_6\: unisim.vcomponents.LUT6
    generic map(
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ps2_keyboard_v1_0_S00_AXI is
  ...
  attribute SOFT_HLUTNM of \led[0]_INST_0\ : label is "soft_lutpair8";
...
uut: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_PS2Receiver
     port map (
      ...
      \keycodev_reg[0]\ => \keycodev[15]_i_7_n_0\
    );
end STRUCTURE;
library IEEE;
use IEEE.STD_LOGIC_1164.ALL;
