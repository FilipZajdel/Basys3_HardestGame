...
HD_PWD='/home/filip/Projects/xilinx/FPGA_GAME/vivado/microblaze_VGA/microblaze_VGA.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log microblaze_MCU_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source microblaze_MCU_wrapper.tcl -notrace
