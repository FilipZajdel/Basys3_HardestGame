...
HD_PWD='/home/filip/fpga_design/ip_repo/edit_vga_basic_control_v1_0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vga_basic_control_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source vga_basic_control_v1_0.tcl
